...
public abstract class BaseMessage implements Serializable
{
  ...
  public int hashCode()
  {
    ...
    result = prime * result + ((objMessageType == null) ? 0 : objMessageType.hashCode());
    result = prime * result + ((objPayload == null) ? 0 : objPayload.hashCode());
    result = prime * result + ((strReceiver == null) ? 0 : strReceiver.hashCode());
