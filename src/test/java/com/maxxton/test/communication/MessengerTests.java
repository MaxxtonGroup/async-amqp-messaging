...
public class MessengerTests {
	...
	/**
	 * Setup method called before running the tests to construct the testing
	 * environment.
	 */
	@Before
	public void setup() {
	...
	public void testCommunicationController() throws Exception {
		System.out
				.print("Messenger : Testing communicationcontroller getter...");

		CommunicationController communication = this.objMessenger
				.getCommunication();
		assertNotNull("The communicationcontroller instance cannot be null.",
				communication);
